...
AMyProjectCharacter::AMyProjectCharacter()
{
	...
	GunOffset = FVector(100.0f, 20.0f, 45.0f);
...
void AMyProjectCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	{
		InputComponent->BindAction("Fire", IE_Pressed, this, &AMyProjectCharacter::OnFireDown);
		InputComponent->BindAction("Fire", IE_Released, this, &AMyProjectCharacter::OnFireUp);
	}
...
void AMyProjectCharacter::OnFireUp()
{
	GetWorldTimerManager().ClearTimer(rapid_fire_handle);
}
